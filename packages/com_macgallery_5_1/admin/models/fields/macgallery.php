 ...
 * @since		1.6
 */
class JFormFieldModal_Macgallery extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since	1.6
	 */
	protected $type = 'Modal_Macgallery';
	...
	protected function getInput()
	{
		...
		$html[] = '	<a class="modal" title="'.JText::_('Select a album').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('Select a album').'</a>';
		$html[] = '  </div>';
		$html[] = '</div>';
