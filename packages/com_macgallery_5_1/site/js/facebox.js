...
(function(apptha) {
  ...
  apptha.facebox.settings = {
    loading_image : apptha('#appthaFaceboxLoading').val(),
    close_image   : apptha('#appthaFaceboxClose').val(),
...
<div class="popup"> \
        ...
        <a href="#" class="close"> \
          <img src="'+this.close_image+'" title="Press ESC to close" class="close_image" /> \
    	   ...
    	   <div class="content" id="appthaContent" style="margin-top:0px !important;"> \
              </div> \
             </td> \
            </tbody> \
      </table> \
